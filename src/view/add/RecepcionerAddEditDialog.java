...
import view.RecepcionerTableFrame;
import manager.RecepcionerManager;


public class RecepcionerAddEditDialog extends JDialog{
    private static final long serialVersionUID = -5247231764310200252L;
	private RecepcionerManager recepcionerMng;
    private Recepcioner zaedit;
	private JFrame parent;

    public RecepcionerAddEditDialog(JFrame parent, RecepcionerManager recepcionerMng,Recepcioner zaedit) {
		super(parent, true);
		this.parent = parent;
		...
		this.recepcionerMng = recepcionerMng;
        this.zaedit = zaedit;
        ...
        bpotvrdi.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae){
                ...
                if(zaedit == null){
                    ...
                    recepcionerMng.registracija(ime, prezime, broj, adresa, pol, korisnickoime, lozinka1, nivo, staz);
                    
                }else
                     recepcionerMng.izmeniRecepcionera(zaedit.getId(), ime, prezime, broj, adresa, pol, korisnickoime, lozinka, nivo, staz);
                ((RecepcionerTableFrame) parent).refreshData();
                RecepcionerAddEditDialog.this.dispose();
